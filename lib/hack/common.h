...
#define PARAM_COLOR_DECREASE_MODEL 7 // 0 or 1 - H

#define PARAM_NB_LINE              8 // I
#define PARAM_NB_LED_PER_LINE      9 // J
...
#define PARAM_SUNSET_OFFSET        28 // AC   Allows to turn on before or after sunset (in minutes)
#define PARAM_SUNRISE_OFFSET       29 // AD   Allows to turn off before or after sunrise (in minutes)
#define PARAM_ACTION_1             30 // AE   Minute event. <0 no action, minutes + intensity (0 to 15) * 2000
#define PARAM_ACTION_2             31 // AF   Minute event. <0 no action, minutes + intensity (0 to 15) * 2000
#define PARAM_ACTION_3             32 // AG   Minute event. <0 no action, minutes + intensity (0 to 15) * 2000
#define PARAM_ACTION_4             33 // AH   Minute event. <0 no action, minutes + intensity (0 to 15) * 2000